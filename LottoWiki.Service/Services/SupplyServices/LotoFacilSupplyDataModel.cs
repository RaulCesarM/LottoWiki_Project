...
namespace LottoWiki.Service.Services.SupplyServices
{
    public class LotoFacilSupplyDataModel : ILotoFacilSupplyDataModel
    {
        ...
        private readonly ILightGbmApplying _lightGbmPreview;

        public LotoFacilSupplyDataModel(ILotoFacilCommonRepositoryStatus status, ILotoFacilQueryCorrelation correlation, ILotoFacilServiceDataModel service, ILogger<LotoFacilSupplyDataModel> logger, ILightGbmApplying lightGbmPreview)
        {
            _status = status;
            _correlation = correlation;
            _service = service;
            _logger = logger;
            _lightGbmPreview = lightGbmPreview;
        }
